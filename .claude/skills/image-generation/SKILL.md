...
AI image generation prompt engineering for DALL-E 3, Gemini Imagen, Stable Diffusion, Midjourney. Use when asked to generate, create, or draw images.

| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `jhamidun-claude-code-config-pack-image-generation`                                |
| Version    | 1.0.1                                     |
| Author     | JHamidun                                 |
| Category   |                                     |
| Installs   | 2                                |
...
**GitHub:** [JHamidun/claude-code-config-pack](https://github.com/JHamidun/claude-code-config-pack) — ⭐  | Forks: 
...
```bash
npx -y @lobehub/market-cli skills install jhamidun-claude-code-config-pack-image-generation
```
...
npx -y @lobehub/market-cli skills install jhamidun-claude-code-config-pack-image-generation --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install jhamidun-claude-code-config-pack-image-generation --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install jhamidun-claude-code-config-pack-image-generation --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install jhamidun-claude-code-config-pack-image-generation --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install jhamidun-claude-code-config-pack-image-generation --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate jhamidun-claude-code-config-pack-image-generation --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment jhamidun-claude-code-config-pack-image-generation -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment jhamidun-claude-code-config-pack-image-generation
```
...
```bash
npx -y @lobehub/market-cli skills comments jhamidun-claude-code-config-pack-image-generation
```
